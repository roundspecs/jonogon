...
public class InitiativeController {
    ...
    public ResponseEntity<Initiative> save(@PathVariable Long jonogonId, @RequestBody Initiative initiative) {
        initiative.setAuthor(jonogonService.findById(jonogonId));
    ...
    // public ResponseEntity<Set<Comment>> findAllComment(@PathVariable Long
    // initiativeId) {
    // return new ResponseEntity<>(initiativeService.findAllComment(initiativeId),
    // HttpStatus.OK);
    // }

    // @PostMapping("{initiativeId}/appreciate/{jonogonId}")
    // public ResponseEntity<HttpStatus> appreciate(@PathVariable Long initiativeId,
    // @PathVariable Long jonogonId) {
    // initiativeService.appreciateBy(initiativeId, jonogonId);
    // return new ResponseEntity<>(HttpStatus.CREATED);
    // }

    // @GetMapping("{initiativeId}/appreciate/{jonogonId}")
    // public ResponseEntity<Boolean> didAppreciate(@PathVariable Long initiativeId,
    // @PathVariable Long jonogonId) {
    // return new ResponseEntity<>(initiativeService.didAppreciate(initiativeId,
    // jonogonId), HttpStatus.OK);
    // }

    // @GetMapping("{initiativeId}/appreciate/count")
    // public ResponseEntity<Integer> appreciateCount(@PathVariable Long
    // initiativeId) {
    // return new ResponseEntity<>(initiativeService.appreciateCount(initiativeId),
    // HttpStatus.OK);
    // }

    // // post
    // @PostMapping("{initiativeId}/iAmIn/{jonogonId}")
    // public ResponseEntity<HttpStatus> iAmIn(@PathVariable Long initiativeId,
    // @PathVariable Long jonogonId) {
    ...
    // public ResponseEntity<Boolean> didIAmIn(@PathVariable Long initiativeId,
    // @PathVariable Long jonogonId) {
    // return new ResponseEntity<>(initiativeService.didIAmIn(initiativeId,
    // jonogonId), HttpStatus.OK);
    // }

    // @GetMapping("{initiativeId}/iAmIn/count")
    // public ResponseEntity<Integer> iAmInCount(@PathVariable Long initiativeId) {
    // return new ResponseEntity<>(initiativeService.iAmInCount(initiativeId),
    // HttpStatus.OK);
    // }
    ...
    // {
    // return new ResponseEntity<>(initiativeService.commentCount(initiativeId),
    // HttpStatus.OK);
    // }
